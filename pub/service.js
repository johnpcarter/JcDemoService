...
this.getAPIList = function() { 
 return [{"name":"jc.demoservice:api","spec":{"swagger":"2.0","info":{"description":"This is a demonstration of how easy it is to build and document your APIs using webMethods Integration.","version":"1.0","title":"HelloWorld API"},"host":"localhost:5555","basePath":"/rad/jc.demoservice:api","consumes":["application/json"],"produces":["application/json"],"paths":{"/v1/greet/{name}":{"get":{"description":"# Demo service, that simply output a localised greeting for the given name.  \n###### version 1.0\n\n**INPUT** \n*name* - (required) name of person to be greeted \n\n**OUTPUT**\n*greeting* - localised greeting including name of person \n \n**EXCEPTION**\n*InvalidNameException* - triggered in \u0027xxx\u0027 given as name \n\n**HISTORY** \nVersion 3.0 (04/04/19) - JC - Update \n- trace is logged to custom file in resources/files \n \nVersion 1.0 (10/10/18) - JC - New \n- Initial rollout ","operationId":"v1greetname_GET_1","parameters":[{"name":"name","in":"path","required":true,"type":"string"}],"responses":{"200":{"description":"OK","schema":{"$ref":"#/definitions/v1greetname_GET_response"}},"401":{"description":"Access Denied"}}}}},"definitions":{"v1greetname_GET_response":{"required":["greeting"],"properties":{"greeting":{"type":"string"}}}},"schemes":["HTTP"]}}];
}
this.getCreatedTime = function() { 
 return "29-11-2022 10:40:54 CET";
}
